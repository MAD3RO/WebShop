    ...
    internal sealed class Configuration : DbMigrationsConfiguration<WebShop.Models.Data.Db>
    {
        ...
        protected override void Seed(WebShop.Models.Data.Db context)
        {
            ...
            var Products = new List<ProductModel>
                {
                    new ProductModel{Name = "ASUS - Gaming Desktop PC", Slug="asus-gaming-desktop-pc", CategoryName="Desktops", Description=" Intel Core i5-9400F (6-Core 2.9 GHz), NVIDIA GeForce GTX 1660, 8 GB DDR4, 512 GB SSD, Intel B360, Windows 10 Home 64-bit, GL10CS", CategoryId=2, ImageName="slika1.jpg", Price=779.98M, Discount=15},
                    new ProductModel{Name = "ABS Mage E", Slug="abs-mage-e", CategoryName="Desktops", Description="Ryzen 5 2600 - B450 Wifi - Radeon RX 5700 - 8GB DDR4 - 512GB SSD ", CategoryId=2, ImageName="slika1.jpg", Price=849.99M, Discount=25},
                    new ProductModel{Name = "HP Business Desktop ProDesk 400 G4", Slug="hp-business-desktop-prodesk-400-G4", CategoryName="Desktops", Description="Intel Core i5 (8th Gen) i5-8500T 2.10 GHz - 8 GB DDR4 SDRAM - 256 GB SSD - Windows 10 Pro 64-Bit (English)", CategoryId=2, ImageName="slika1.jpg", Price=649, Discount=0},
                    new ProductModel{Name = "Lenovo ThinkCentre M910s", Slug="lenovo-thinkcentre-m910s", CategoryName="Desktops", Description="Intel Core i5-7500 (3.40 GHz) - 8 GB RAM - 256 GB SSD - Windows 10 Pro 64-bit (English) - Small Form Factor - Black", CategoryId=2, ImageName="slika1.jpg", Price=644.99M, Discount=0},
                    new ProductModel{Name = "iBUYPOWER AlphaB 3660SA", Slug="ibuypower-alphab-3660sa", CategoryName="Desktops", Description="AMD Ryzen 5 3600 (3.60 GHz) NVIDIA GeForce RTX 2060 SUPER 16 GB DDR4 480 GB SSD Windows 10 Home 64-bit", CategoryId=2, ImageName="slika1.jpg", Price=1079.99M, Discount=10},
                    new ProductModel{Name = "Dell Precision T3630 Workstation", Slug="dell-precision-t3630-workstation", CategoryName="Desktops", Description="Intel i7-8700K 6-Core up to 4.7GHz, 32GB DDR4, 2TB HDD + 512GB SSD , Windows 10 Pro 64-bit, 3000 Series Tower NVIDIA Quadro P620", CategoryId=2, ImageName="slika1.jpg", Price=1672.99M, Discount=30},
                    new ProductModel{Name = "iBUYPOWER Slate 106AV2", Slug="IBUYPOWER-SLATE-106AV2", CategoryName="Desktops", Description="AMD Ryzen 5 3600 (3.60 GHz) NVIDIA GeForce GTX 1660 8 GB DDR4 500 GB SSD Windows 10 Home 64-bit", CategoryId=2, ImageName="slika1.jpg", Price=919.99M, Discount=20},
                    //new ProductModel{Name = "Produkt", Slug="produkt", CategoryName="Voće", Description="opis", CategoryId=2, ImageName="slika1.jpg", Price=12},
                    //new ProductModel{Name = "Produkt", Slug="produkt", CategoryName="Voće", Description="opis", CategoryId=2, ImageName="slika1.jpg", Price=12},
                    //new ProductModel{Name = "Produkt", Slug="produkt", CategoryName="Voće", Description="opis", CategoryId=2, ImageName="slika1.jpg", Price=12},
                    //new ProductModel{Name = "Produkt", Slug="produkt", CategoryName="Voće", Description="opis", CategoryId=2, ImageName="slika1.jpg", Price=12},
                    new ProductModel{Name = "GIGABYTE - AERO 15 OLED SA-7US5020SH", Slug="gigabyte-aero-15", CategoryName="Laptops", Description="Gaming Laptop - 15.6' 4K UHD AMOLED - Intel Core i7-9750H - NVIDIA GeForce GTX 1660 Ti - 8 GB Memory 256 GB SSD - Win 10", CategoryId=3, ImageName="slika1.jpg", Price=1449, Discount=30}
                };
